<section id="beranda" class="dark:bg-gray-900 pt-4 md:pt-12">
    <div class="mx-auto max-w-screen-xl flex flex-col md:flex-row md:justify-between">
        ...
        <div class=" w-full md:w-3/5  flex flex-col justify-center mx-auto md:p-0 p-4 items-center md:items-baseline">
            ...
            <div class="mb-4 text-center md:text-left text-3xl md:text-7xl font-extrabold" data-aos="fade-up"
            ...
            <p data-aos="fade-up" data-aos-duration="1500"
                ...
                website.</p>
            <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 gap-4" data-aos="fade-up"
                data-aos-duration="1500">

                <a href="#kontak"
                    class="bg-[#7959D6] text-white text-center px-4 py-3 font-medium text-xl rounded-md hover:bg-[#6c57aa]">Hubungi
                    Saya</a>

                <a href="https://drive.google.com/drive/folders/1IskK6iuWbhCDv_pDABaecAd0wVoCjR6j?usp=sharing"
                    target="_blank"
                    class="bg-[#FD7E41] text-white text-center px-4 py-3 font-medium text-xl rounded-md hover:bg-[#ce8563]">Curriculum
                    Vitae
                </a>
            </div>
        </div>

        <div class="md:w-2/5 w-full md:p-0 px-4 pt-4 md:pt-0 flex justify-center mx-auto md:mx-0" data-aos="zoom-in"
            data-aos-duration="1500">
